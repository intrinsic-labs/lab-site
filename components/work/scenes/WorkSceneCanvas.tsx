...
import type { WorkSceneId } from "@/lib/content/schema";
 ...
 */
const SCENES: Record<WorkSceneId, ComponentType> = {
 ...
 * and the 16:9 case-study hero); the scene itself always fills that box at 100%.
 */
export function WorkSceneCanvas({ scene, seed, className }: { scene?: WorkSceneId; seed: string; className?: string }) {
